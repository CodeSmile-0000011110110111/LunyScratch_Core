...
namespace LunyScratch
{
	public static partial class Blocks
	{
		...
		public static IScratchBlock AddVariable(String name, Variable amount) => new ModifyVariableByNameBlock(name, MathOperator.Add, amount);
		...
		public static IScratchBlock SubtractVariable(String name, Variable amount) => new ModifyVariableByNameBlock(name, MathOperator.Subtract, amount);
		...
		public static IScratchBlock MultiplyVariable(String name, Variable by) => new ModifyVariableByNameBlock(name, MathOperator.Multiply, by);
		...
		public static IScratchBlock DivideVariable(String name, Variable by) => new ModifyVariableByNameBlock(name, MathOperator.Divide, by);
		...
		public static IScratchBlock ModuloVariable(String name, Variable by) => new ModifyVariableByNameBlock(name, MathOperator.Modulo, by);
		...
		public static IScratchBlock SetVariable(String name, Variable value) => new ModifyVariableByNameBlock(name, MathOperator.Assign, value);
		...
		public static IScratchBlock AddVariable(Variable variable, Variable amount) => new ModifyVariableBlock(variable, MathOperator.Add, amount);
		...
		public static IScratchBlock SubtractVariable(Variable variable, Variable amount) => new ModifyVariableBlock(variable, MathOperator.Subtract, amount);
		...
		public static IScratchBlock MultiplyVariable(Variable variable, Variable by) => new ModifyVariableBlock(variable, MathOperator.Multiply, by);
		...
		public static IScratchBlock DivideVariable(Variable variable, Variable by) => new ModifyVariableBlock(variable, MathOperator.Divide, by);
		...
		public static IScratchBlock ModuloVariable(Variable variable, Variable by) => new ModifyVariableBlock(variable, MathOperator.Modulo, by);
		...
		public static IScratchBlock SetVariable(Variable variable, Variable value) => new ModifyVariableBlock(variable, MathOperator.Assign, value);
		...
		public static ConditionBlock IsVariableLessThan(Variable variable, Variable value) => new IsVariableConditionBlock(variable, value, ComparisonOperator.Less);
		...
		public static ConditionBlock IsVariableLessOrEqual(Variable variable, Variable value) => new IsVariableConditionBlock(variable, value, ComparisonOperator.LessOrEqual);
		...
		public static ConditionBlock IsVariableEqualTo(Variable variable, Variable value) => new IsVariableConditionBlock(variable, value, ComparisonOperator.Equal);
		...
		public static ConditionBlock IsVariableNotEqualTo(Variable variable, Variable value) => new IsVariableConditionBlock(variable, value, ComparisonOperator.NotEqual);
		...
		public static ConditionBlock IsVariableGreaterThan(Variable variable, Variable value) => new IsVariableConditionBlock(variable, value, ComparisonOperator.Greater);
		...
		public static ConditionBlock IsVariableGreaterOrEqual(Variable variable, Variable value) => new IsVariableConditionBlock(variable, value, ComparisonOperator.GreaterOrEqual);
		...
		public static ConditionBlock IsVariableLessThan(String name, Variable value) => new IsVariableConditionBlock(name, value, ComparisonOperator.Less);
		...
		public static ConditionBlock IsVariableLessOrEqual(String name, Variable value) => new IsVariableConditionBlock(name, value, ComparisonOperator.LessOrEqual);
		...
		public static ConditionBlock IsVariableEqualTo(String name, Variable value) => new IsVariableConditionBlock(name, value, ComparisonOperator.Equal);
		...
		public static ConditionBlock IsVariableNotEqualTo(String name, Variable value) => new IsVariableConditionBlock(name, value, ComparisonOperator.NotEqual);
		...
		public static ConditionBlock IsVariableGreaterThan(String name, Variable value) => new IsVariableConditionBlock(name, value, ComparisonOperator.Greater);
		...
		public static ConditionBlock IsVariableGreaterOrEqual(String name, Variable value) => new IsVariableConditionBlock(name, value, ComparisonOperator.GreaterOrEqual);
	}
}
